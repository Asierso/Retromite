...
namespace retromite
{
    class window
    {
        public static void textWindow(int posX,int posY,int size,string title,string content)
        {
        ...
        public static void buttonWindow(int posX,int posY,int size,string title,string content,List<string> buttons)
        {
            ConsoleColor oldBgColor = Console.BackgroundColor;
            ConsoleColor oldFgColor = Console.ForegroundColor;
            Console.BackgroundColor = ConsoleColor.Gray;
